...
namespace WrysersGoPro
{
    ...
    public class Plugin : BaseUnityPlugin
    {
            ...
            if (initialized)
            {
                ...
                if (!GoProConfig.ControlLock)
                {
                    ...
                    if (GoProManager.followPlayer)
                    {
                        ...
                        cam.transform.LookAt(camFollower.position - camFollower.position + GTPlayer.Instance.headCollider.transform.position);
                    ...
                    if (sec && !grabbable)
                    {
                        if (sticking)
                        {
                            cam.transform.SetParent(GTPlayer.Instance.bodyCollider.transform);
                        }
                        else
                        {
        ...
        void MakeCamera()
        {
            ...
            Rhand = GameObject.Find("Player Objects/Local VRRig/Local Gorilla Player/GorillaPlayerNetworkedRigAnchor/rig/body/shoulder.R/upper_arm.R/forearm.R/hand.R/");
            Lhand = GameObject.Find("Player Objects/Local VRRig/Local Gorilla Player/GorillaPlayerNetworkedRigAnchor/rig/body/shoulder.L/upper_arm.L/forearm.L/hand.L/");
            ...
            stinkymonkeyface = GameObject.Find("Player Objects/Local VRRig/Local Gorilla Player/GorillaPlayerNetworkedRigAnchor/rig/body/head/");
